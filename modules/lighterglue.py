...
class LighterGlue(nn.Module):
    ...
    default_conf_GMSNet = {
    "name": "GMSNet",  # just for interfacing
    ...
    def __init__(self, weights = os.path.abspath(os.path.dirname(__file__)) + '/../weights/GMSNet-lighterglue.pt'):
        super().__init__()
        LightGlue.default_conf = self.default_conf_GMSNet
        ...
        if os.path.exists(weights):
            ...
            state_dict = torch.hub.load_state_dict_from_url("https://github.com/verlab/accelerated_features/raw/main/weights/GMSNet-lighterglue.pt")
